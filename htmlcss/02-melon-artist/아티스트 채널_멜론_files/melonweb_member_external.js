    ...
    if(arrayDomain==null || arrayDomain[2]==undefined){
      httpsWwwDomain = "https://www.melon.com";
		...
		if(objectId!=undefined && objectId!=''){
		    ...
		    if (headerLayout == null) {
		    	...
		    	if(pageCode=='LOGIN' || pageCode=='EMAILRECEIVECANCEL'){
					...
					if(isMelonLogin()){
						...
						headerLayout.innerHTML += "<a href='"+sslMemberDomain+"/muid/web/update/memberinfomationupdateform_inform.htm'>"+getDisplayId()+"</a></span> 님</span>";
			...
			document.write("							</li>");
			document.write("							<li class=''>");
			document.write("								<a href='"+httpsWwwDomain+"/flac/index.htm' class='menu09' title='멜론Hi-Fi'>멜론Hi-Fi</a>");
			document.write("							</li>");
			document.write("						</ul>");
			document.write("					</div>");
			document.write("				</div>");
			...
			if(isMelonLogin()){
				...
				document.write("<a href='"+sslMemberDomain+"/muid/web/update/memberinfomationupdateform_inform.htm'>"+getDisplayId()+"</a></span> 님</span>");
				if (fromMPS == null || fromMPS.indexOf("MELONPLAYER") < 0) {
...
//			document.write("			</ul>");
      ...
      document.write("				<li class='menu05'><a title='멜론5.0 둘러보기 - 페이지 이동' href='"+httpsWwwDomain+"/event/fiveintro/index.htm' target='fiveintro'><span>멜론5.0 둘러보기</span></a></li>");
			...
			document.write("			<li><a href='"+sslInfoDomain+"/terms/web/terms1_3.html' title='위치기반서비스 이용약관 ' target='_blank'>위치기반서비스 이용약관</a></li>");
